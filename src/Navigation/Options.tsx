...
const CustomDrawerItem = ({label, icon}: any) => (
  <DrawerItem
    label={label}
    ...
    <Stack.Navigator initialRouteName="Home">
      <Stack.Screen name="KRICH WATER REFILLING STATION">
        {() => (
          ...
          <Drawer.Navigator screenOptions={{drawerActiveTintColor: 'blue'}}>
            <Drawer.Screen
              name="Home"
              options={{
              ...
              initialParams={{details}} //This is the data containing User who logged in
            />
            <Drawer.Screen
              name="My Cart"
              component={MyCart}
